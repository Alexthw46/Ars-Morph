...
public class FirenandoAbility extends MorphBoundAbility<FirenandoEntity> {
    ...
    public FirenandoAbility() {
        super(FirenandoEntity.class);
    }

    @Override
    protected void use(Player player, FirenandoEntity firenandoEntity) {
